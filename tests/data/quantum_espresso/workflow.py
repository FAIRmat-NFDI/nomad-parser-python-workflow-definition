...
from optimade.models.structures import StructureResource, StructureResourceAttributes
...
def json_to_ase(atoms_json):
    ...
    return get_ase_atoms(
        optimade_structure=StructureResource(id='ase', attributes=structure_restore)
    )
